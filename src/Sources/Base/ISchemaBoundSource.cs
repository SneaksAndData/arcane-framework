...
public interface ISchemaBoundSource<TOut, TMat, TSchema> : ISchemaFreeSource<TOut, TMat>
    where TSchema : ISchemaValidator<TOut>
{
    ...
    ISchemaBoundSource<TOut2, TMat, TNewSchema> Map<TOut2, TNewSchema>(Func<TOut, TOut2> mapper, TNewSchema newSchema)
